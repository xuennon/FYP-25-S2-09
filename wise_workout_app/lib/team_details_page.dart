...
class _TeamDetailsPageState extends State<TeamDetailsPage> {
  late Map<String, String> currentTeamData;
  final TeamState _teamState = TeamState();

  @override
  void initState() {
    super.initState();
    currentTeamData = Map.from(widget.teamData);
  }  @override
      ...
      body: SingleChildScrollView(
        child: Column(
          ...
          children: [
                    ...
                    child: _buildActionButton(
                      ...
                      onTap: () async {
                        ...
                        if (result != null && result is Map<String, String>) {
                          setState(() {
                            currentTeamData = result;
                            _teamState.updateTeam(result); // Update the global state
                          });
                        }
                      },
                    ),
            ...
            if (currentTeamData['description']?.isNotEmpty == true) ...[
              Container(
                padding: const EdgeInsets.symmetric(horizontal: 24),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: [
            ...
            TextButton(
              onPressed: () {
                _teamState.deleteTeam(); // Remove team from global state
                Navigator.of(context).pop();
                  ...
                  children: [
                    ...
                    _buildShareOption(
                      ...
                      onTap: () {
                        ...
                        String teamLink = 'https://wiseworkout.com/teams/${currentTeamData['name']?.replaceAll(' ', '_').toLowerCase() ?? 'team'}';
