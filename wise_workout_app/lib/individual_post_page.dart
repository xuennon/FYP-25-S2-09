...
class _IndividualPostPageState extends State<IndividualPostPage> {
        ...
        children: [
          ...
          Row(
            children: [
              ...
              _currentPost.userAvatar == 'current_user' 
                ...
                : _currentPost.userAvatar == 'business_user'
                  ? Container(
                      width: 40,
                      height: 40,
                  ...
                  : Container(
                      ...
                      decoration: BoxDecoration(
                        shape: BoxShape.circle,
                        color: Colors.blue,
                        image: _currentPost.userAvatar != null && _currentPost.userAvatar != 'current_user' && _currentPost.userAvatar != 'business_user'
                            ? DecorationImage(
                      ...
                      child: _currentPost.userAvatar == null || _currentPost.userAvatar == 'current_user' || _currentPost.userAvatar == 'business_user'
                          ? Center(
                              child: Text(
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        // Business badge
                        if (_currentPost.userAvatar == 'business_user') ...[
          ...
          Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                if (_currentPost.title != null && _currentPost.title!.isNotEmpty && _currentPost.userAvatar == 'business_user') ...[
                  Text(
                    _currentPost.title!,
                    style: const TextStyle(
                      fontSize: 18,
                ...
                // For business posts, show content below image; for regular posts, show above
                if (_currentPost.content.isNotEmpty && _currentPost.userAvatar != 'business_user')
                  Text(
          ...
          if (_currentPost.images.isNotEmpty) ...[
            Container(
              ...
              child: PostImageGrid(images: _currentPost.images),
            ),
          ],
          
          // Business post description below image
          if (_currentPost.content.isNotEmpty && _currentPost.userAvatar == 'business_user') ...[
            Padding(
  ...
  Widget _buildImageGrid(List<String> images) {
    ...
    if (images.length == 1) {
      ...
      if (imagePath.startsWith('/') || imagePath.contains('cache') || imagePath.contains('Documents')) {
        return Container(
