...
class _DiscoveredTeamDetailsPageState extends State<DiscoveredTeamDetailsPage> {
  ...
  void initState() {
    super.initState();
    // Use the global state instead of the passed parameter
    isJoined = _joinedTeamsState.isTeamJoined(widget.teamData['name']!);
  }
                    ...
                    child: _buildActionButton(
                      ...
                      onTap: () {
                        setState(() {
                          isJoined = !isJoined;
                          if (isJoined) {
                            _joinedTeamsState.joinTeam(widget.teamData);
                          } else {
                            _joinedTeamsState.leaveTeam(widget.teamData['name']!);
                          }
                        });
