...
class _UserHomePageState extends State<UserHomePage> {
      ...
      child: Card(
        ...
        child: Padding(
          ...
          child: Column(
            ...
            Row(
              children: [
                // User avatar - handle different user types
                    ...
                    children: [
                      Row(
                        children: [
                          ...
                          // Business badge
                          if (post.userAvatar == 'business_user') ...[
                            const SizedBox(width: 8),
                            Container(
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if (post.content.isNotEmpty && post.userAvatar != 'business_user')
                    Text(
                      post.content,
                      style: const TextStyle(
                        fontSize: 16,
  ...
  Widget _buildImageGrid(List<String> images) {
    return PostImageGrid(images: images);
  }

  Widget _buildUserAvatar(Post post) {
    if (post.userAvatar == 'current_user') {
      return UserAvatar(
        radius: 20,
        onTap: () {
          Navigator.push(
    ...
    } else if (post.userAvatar == 'business_user') {
      // Business user avatar with distinctive styling
      return Container(
        width: 40,
        height: 40,
        decoration: BoxDecoration(
      ...
      return Container(
        ...
        decoration: BoxDecoration(
          shape: BoxShape.circle,
          color: Colors.blue,
          image: post.userAvatar != null && post.userAvatar != 'current_user' && post.userAvatar != 'business_user'
              ? DecorationImage(
        ...
        child: post.userAvatar == null || post.userAvatar == 'current_user' || post.userAvatar == 'business_user'
            ? Center(
                child: Text(
